...
import { IconEye, IconImage, IconLogout, IconPrinter, IconSettings } from "@/components/ui/icons";
        ...
        <div className="mx-auto flex h-16 max-w-6xl items-center gap-4 px-4 sm:px-6">
          ...
          <div className="ml-auto flex items-center gap-1">
            <a
              ...
              target="_blank"
              rel="noopener"
              className="flex h-10 items-center gap-2 rounded-xl px-3 text-[14px] font-semibold text-ink-soft transition-colors hover:bg-paper-deep/70 hover:text-ink"
            >
              <IconEye size={18} />
              <span className="hidden md:inline">전시 보기</span>
            </a>
