...
export const ERROR_MESSAGES = {
  UNKNOWN: "잠시 문제가 생겼습니다. 잠시 후 다시 시도해 주세요.",
  NETWORK: "인터넷 연결이 불안정합니다. 연결을 확인한 뒤 다시 시도해 주세요.",
  UNAUTHORIZED: "로그인이 필요합니다. 다시 로그인해 주세요.",
  LOGIN_FAILED: "비밀번호가 맞지 않습니다. 다시 입력해 주세요.",
  LOGIN_LOCKED: "비밀번호를 여러 번 틀렸습니다. 5분 뒤에 다시 시도해 주세요.",
  LOGIN_EMPTY: "비밀번호를 입력해 주세요.",
  VALIDATION: "입력한 내용을 다시 확인해 주세요.",
  NOT_FOUND: "작품을 찾을 수 없습니다. 이미 삭제되었을 수 있습니다.",
  SAVE_FAILED: "저장하지 못했습니다. 잠시 후 다시 시도해 주세요.",
  DELETE_FAILED: "삭제하지 못했습니다. 잠시 후 다시 시도해 주세요.",
  REORDER_FAILED: "순서를 바꾸지 못했습니다. 잠시 후 다시 시도해 주세요.",
  UPLOAD_FAILED: "파일을 올리지 못했습니다. 다시 시도해 주세요.",
  UPLOAD_PENDING: "아직 올리는 중이거나 실패한 파일이 있습니다. 파일 상태를 확인해 주세요.",
  FILE_TOO_LARGE: "파일이 너무 큽니다. 더 작은 파일을 사용해 주세요.",
  IMAGE_UNSUPPORTED: "이 사진은 읽을 수 없습니다. JPG, PNG, HEIC 사진을 사용해 주세요.",
  IMAGE_PROCESS_FAILED: "사진을 변환하지 못했습니다. 다른 사진으로 다시 시도해 주세요.",
  IMAGE_LIMIT: "사진은 작품마다 12장까지 올릴 수 있습니다.",
  MIC_DENIED: "마이크 사용이 허용되지 않았습니다. 브라우저 설정에서 마이크 권한을 켜 주세요.",
  MIC_NOT_FOUND: "마이크를 찾을 수 없습니다. 마이크가 연결되어 있는지 확인해 주세요.",
  RECORDING_UNSUPPORTED: "이 브라우저에서는 녹음을 할 수 없습니다. 녹음 파일을 올려 주세요.",
  RECORDING_FAILED: "녹음 중 문제가 생겼습니다. 다시 녹음해 주세요.",
  AUDIO_UNSUPPORTED: "이 소리 파일은 사용할 수 없습니다. m4a, mp3, webm 파일을 올려 주세요.",
  AUDIO_TOO_LONG: "녹음은 3분까지 사용할 수 있습니다.",
  YOUTUBE_INVALID: "유튜브 영상 주소가 올바르지 않습니다. 영상 주소를 그대로 붙여넣어 주세요.",
  COPY_FAILED: "링크를 복사하지 못했습니다. 주소창의 주소를 직접 복사해 주세요.",
